...
public class Magpie5 {
	...
	private String[] randomResponses = { "Interesting, tell me more", "Hmmm.",
			"Do you really think so?", "You don't say.","How interesting","can you repeat that?","Thats Neat","DO you think that when a nuclear war breaks out and destroys all civilizations excsept the ones in the jungals, and so they try to rise to power and a new jungle warfare would break out?" };
